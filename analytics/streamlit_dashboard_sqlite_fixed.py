"""
Dashboard Streamlit qui lit depuis SQLite - Version corrigée.
Usage:
    streamlit run analytics/streamlit_dashboard_sqlite_fixed.py
"""
...
def main() -> None:
    ...
    st.write("Suivez en temps réel les flux de transactions ingérées depuis un fichier et stockées dans SQLite.")
    ...
    try:
        ...
        pass  # Les erreurs sont gérées dans get_engine()
